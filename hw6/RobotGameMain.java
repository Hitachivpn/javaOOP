...
public class RobotGameMain {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("""
                    ...
                    1. Для создания робота введите:
                        create R1 x y, где R1 - тип робота №1, x и y - координаты для нового робота
                        create R2 x y, где R1 - тип робота №2, x и y - координаты для нового робота
        ...
        //  Везде наружу (в метод #main) отдавать интерфейс. Создание объекта конкретного класса должно быть ровно в одном месте внутри класса RobotMap.
